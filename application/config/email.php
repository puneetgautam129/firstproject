...
$config['smtp_host']        = 'sg2plcpnl0195.prod.sin2.secureserver.net';
...
$config['smtp_user']        = 'info@brajsolar.com';
$config['smtp_pass']        = 'Mohit@pass1';
$config['smtp_port']        = 465;
$config['smtp_timeout']     = 50;                       // (in seconds)
